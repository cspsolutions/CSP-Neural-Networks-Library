...
{
	/// <summary>
	/// Summary description for Sigmoud Activation Function.
	/// </summary>
	public class Sigmoud :AActivationFunction		
	{
		/// <summary>
		/// Default constructor
		/// </summary>
		public Sigmoud():base()
		{			
			this._type = ActivationType.Sigmoud;
		}
		...
		{
			return ( this._value = ( 1 / ( 1 + Math.Exp( -net )) ) );
		}
